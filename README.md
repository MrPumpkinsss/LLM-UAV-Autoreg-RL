...
Latest full benchmark: `3 seeds x 64 states = 192 states`, `N=5` UAVs, `28` LLM layers, `1024` RL candidates per state, evaluated on CUDA.
...
|---|---:|---:|---:|---:|---:|
| autoreg_rl_pure | -0.199125 +/- 0.065751 | 1.0000 | 1.9408 | 31.2131 | 0.28044s |
| hybrid_heuristic | -0.199647 +/- 0.069228 | 1.0000 | 1.9431 | 31.2361 | 0.01101s |
| beam_search | -0.201854 +/- 0.072310 | 1.0000 | 1.9615 | 31.2646 | 0.01101s |
| simulated_annealing | -0.267850 +/- 0.134952 | 1.0000 | 2.4852 | 32.3142 | 0.01101s |
| local_search | -0.269031 +/- 0.136775 | 1.0000 | 2.4911 | 32.3601 | 0.01101s |
| pdp_aware_greedy | -0.286648 +/- 0.154524 | 1.0000 | 2.6246 | 32.6885 | 0.01101s |
| latency_greedy | -8.859663 +/- 27.554457 | 0.9167 | 10.4054 | 41.0712 | 0.01101s |
| block_balanced | -16.508051 +/- 36.025838 | 0.8438 | 18.0614 | 47.5062 | 0.01101s |
| random | -100.000000 +/- 0.000000 | 0.0000 | 107.6689 | 100.4916 | 0.01101s |

Mean margin of `autoreg_rl_pure` vs the best non-RL heuristic: `+0.00052217`. Win/tie rate: `0.5156`.
...
- `results/benchmark_autoreg_gpu_full`: latest full CUDA benchmark.
